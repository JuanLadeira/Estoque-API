...
from estoque_api.produto.views.decorators.categoria_decorators import create_categoria_schema, list_categoria_schema, retrieve_categoria_schema,destroy_categoria_schema, partial_update_categoria_schema, update_categoria_schema
