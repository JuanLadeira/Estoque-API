...
from estoque_api.produto.views.decorators.produto_decorators import create_product_schema, update_product_schema, partial_update_product_schema, retrieve_product_schema, list_product_schema, destroy_product_schema
